...
void ADSPlayerController::Login()
{
	/*
...
void ADSPlayerController::HandleLoginCompleted(int32 LocalUserNum, bool bWasSuccessful, const FUniqueNetId& UserId, const FString& Error)
{
	/*
...
void ADSPlayerController::FindSessions(FName SearchKey, FString SearchValue) //put default value for example 
{
...
void ADSPlayerController::HandleFindSessionsCompleted(bool bWasSuccessful, TSharedRef<FOnlineSessionSearch> Search)
{
...
void ADSPlayerController::JoinSession()
{
...
void ADSPlayerController::HandleJoinSessionCompleted(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
