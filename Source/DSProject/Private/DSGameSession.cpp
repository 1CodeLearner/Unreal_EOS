...
ADSGameSession::ADSGameSession()
{

}

void ADSGameSession::BeginPlay()
{
	Super::BeginPlay();
...
bool ADSGameSession::ProcessAutoLogin()
{
...
void ADSGameSession::CreateSession(FName KeyName, FString KeyValue)
{
...
void ADSGameSession::HandleCreateSessionCompleted(FName EOSSessionName, bool bWasSuccessful) // Dedicated Server Only
{
...
void ADSGameSession::RegisterPlayer(APlayerController* NewPlayer, const FUniqueNetIdRepl& UniqueId, bool bWasFromInvite)
{
    ...
    if (IsRunningDedicatedServer()) // Only run this on the dedicated server
    {
        ...
        RegisterPlayerDelegateHandle =
            Session->AddOnRegisterPlayersCompleteDelegate_Handle(FOnRegisterPlayersCompleteDelegate::CreateUObject(
                this,
                &ADSGameSession::HandleRegisterPlayerCompleted));
...
void ADSGameSession::HandleRegisterPlayerCompleted(FName EOSSessionName, const TArray<FUniqueNetIdRef>& PlayerIds, bool bWasSuccesful)
{
...
void ADSGameSession::StartSession()
{
    ...
    StartSessionDelegateHandle =
        Session->AddOnStartSessionCompleteDelegate_Handle(FOnStartSessionCompleteDelegate::CreateUObject(
            this,
            &ADSGameSession::HandleStartSessionCompleted)); 
...
void ADSGameSession::HandleStartSessionCompleted(FName EOSSessionName, bool bWasSuccessful)
{
...
void ADSGameSession::PostLogin(APlayerController* NewPlayer)
{
    Super::PostLogin(NewPlayer);
}

void ADSGameSession::UnregisterPlayer(const APlayerController* ExitingPlayer)
{
...
void ADSGameSession::HandleUnregisterPlayerCompleted(FName EOSSessionName, const TArray<FUniqueNetIdRef>& PlayerIds, bool bWasSuccesful)
{
...
void ADSGameSession::NotifyLogout(const APlayerController* ExitingPlayer)
{
...
void ADSGameSession::EndSession()
{
    ...
    EndSessionDelegateHandle =
        Session->AddOnEndSessionCompleteDelegate_Handle(FOnEndSessionCompleteDelegate::CreateUObject(
            this,
            &ADSGameSession::HandleEndSessionCompleted));
...
void ADSGameSession::HandleEndSessionCompleted(FName EOSSessionName, bool bWasSuccessful)
{
...
void ADSGameSession::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void ADSGameSession::DestroySession()
{
...
void ADSGameSession::HandleDestroySessionCompleted(FName EOSSessionName, bool bWasSuccesful)
{
