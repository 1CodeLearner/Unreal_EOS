...
#include "DSGameSession.generated.h"

/**
 * 
 */
UCLASS()
class DSPROJECT_API ADSGameSession : public AGameSession
{
	GENERATED_BODY()
...
protected:
	...
	// Hardcoding map for session. 
	const FString Map = TEXT("/Game/ThirdPerson/Maps/ThirdPersonMap"); 
